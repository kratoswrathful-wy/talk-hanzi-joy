...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      name: "chromium",
      dependencies: ["setup"],
      testMatch: /(dev-switch-user-persona|cat-navigation-2-3q|cat-bcd-wave-acceptance|ai-bridge-phase2|w5-phase2-billing-rls|w10-fees-visible-pm|w10-fees-visible-translator|cat-ai-batch-progress|cat-modal-state-bridge|cat-meta-display-map|lms-read-path-request-count|lms-tool-set-field|lms-client-invoice-bridge|case-copy-title-refresh|smoke-cases-translator-update-rpc)\.spec\.ts/,
      use: {
