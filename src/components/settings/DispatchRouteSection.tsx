...
/** 設定 → 派案來源 */
export function DispatchRouteSection() {
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-6 gap-4 flex flex-col">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-0.5">管理派案來源選項的顯示順序與顏色</p>
      </div>
          ...
          >
            ...
            <span
              ...
              style={{
                ...
                color: labelStyles.dispatchRoute.textColor,
            ...
            <div className="ml-auto flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  confirmDelete(() => selectOptionsStore.deleteOption("dispatchRoute", opt.id), opt.label);
                }}
              >
          ...
          {textColorOpen && (
            <div className="mt-2 flex items-center gap-3">
              <span
                ...
                style={{
                  backgroundColor: routeOptions[0]?.color || PRESET_COLORS[0],
                  color: labelStyles.dispatchRoute.textColor,
                  borderColor: routeOptions[0]?.color || PRESET_COLORS[0],
                }}
              >
                預覽
              </span>
