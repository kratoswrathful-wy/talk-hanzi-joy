...
export const UI_BUTTON_REGISTRY: UiButtonDef[] = [
  ...
  {
    id: "cases_mark_delivered",
    label: "交件完畢",
    module: "案件管理",
    locations: ["案件總表（批次）", "案件個別頁"],
    description:
      "顏色僅由此處與下方預設決定，與「狀態標籤」中的「已派出」等設定互不相連；變更標籤色不會影響此按鈕。預設綠色僅為初始外觀，與標籤無執行期連動。",
  ...
  },
  {
    ...
    label: "複製本頁",
    module: "費用管理",
    locations: ["費用個別頁（譯者費用詳情）"],
    description: "與案件「複製本頁」分開設定；預設外觀與案件詢案列白底黑字相同。",
    defaultIconKey: "lucide:Copy",
    defaultBg: "#FFFFFF",
    defaultText: "#0A0A0A",
    appearance: "light",
