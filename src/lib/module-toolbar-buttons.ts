 ...
 * 新模組請沿用此常數，保持寬高一致。
 */
/** 寬度由設定「工具列按鈕」的共用寬度（inline style minWidth／width）控制 */
export const MODULE_TOOLBAR_BTN =
  "h-9 min-h-9 shrink-0 px-2 text-xs gap-1.5 justify-center inline-flex [&_svg]:shrink-0 max-w-full overflow-hidden";
