...
- [`docs/CAT_EDITOR_TAG_COLOR_AND_NAV_FIX_2026-06.md`](docs/CAT_EDITOR_TAG_COLOR_AND_NAV_FIX_2026-06.md) — **Phase 2.3**（`0670242`）+ **2.3b** `694fa81` + **2.3c** `0a073ea`（驗收未通過）+ **2.3d** `42bbd17` + **2.3e** `78818d0`（部分未通過）+ **2.3f** 焦點管線；**2.3f 待驗收**
