...
- [`docs/CAT_MQXLIFF_INSERTED_MATCH_UI_2026-06.md`](docs/CAT_MQXLIFF_INSERTED_MATCH_UI_2026-06.md) — mqxliff **memoQ 預翻記錄**（`<mq:insertedmatch>`）右欄獨立區塊；Team jsonb + `tryParseJson` 讀回修正；驗收與除錯
