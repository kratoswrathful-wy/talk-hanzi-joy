...
- [`docs/CAT_WORKFLOW_PHASE_B_SPEC_2026-06.md`](docs/CAT_WORKFLOW_PHASE_B_SPEC_2026-06.md) — **Phase B Workflow** 完整規格（v4 已落地；**v5 已實作**：`collab_row_id` text 修正、檔案清單 assignment 逐行顯示、LMS 升級條件、任務完成 Dexie 掃描；§11）
