...
- [`docs/CAT_EDITOR_TAG_COLOR_AND_NAV_FIX_2026-06.md`](docs/CAT_EDITOR_TAG_COLOR_AND_NAV_FIX_2026-06.md) — **Phase 2.3** … + **2.3o 審稿外圈 2.5px 待驗收**（§3.17）；**2.3q 共用導覽完成條件規劃中、未實作**（§3.18、[`CAT_EDITOR_NAV_PHASE_2_3Q_PLAN.md`](docs/CAT_EDITOR_NAV_PHASE_2_3Q_PLAN.md)）；2.3p hotfix `649ef70`；2.3n 已通過（§3.15–§3.16）；2.3k／2.3l 部分項仍見 §3.11／§3.13 — 色點見 [`CAT_SEGMENT_USER_MARKERS_2026-06.md`](docs/CAT_SEGMENT_USER_MARKERS_2026-06.md)
