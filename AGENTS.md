...
- [`docs/CAT_WORKFLOW_PHASE_B_SPEC_2026-06.md`](docs/CAT_WORKFLOW_PHASE_B_SPEC_2026-06.md) — **Phase B Workflow** 完整規格（v4 已落地；v5 規劃中：`collab_row_id` Bug 修正、檔案清單 assignment 逐行顯示、CAT→LMS 狀態升級、任務完成條件強化；§11 為 v5 完整規格）
