...
- [`docs/CAT_LMS_1UP_UX_AND_MIGRATION_DEVLOG_2026-06.md`](docs/CAT_LMS_1UP_UX_AND_MIGRATION_DEVLOG_2026-06.md) — **1UP CAT／LMS 整合主紀錄**（`7ae0fc5`～`27d0585`：第二波 UX、B+D2、UX 微調、遷移 dry-run、加號樣式與驗收）
- [`docs/CAT_MIGRATE_LEGACY_CAT_TOOL_2026-06.md`](docs/CAT_MIGRATE_LEGACY_CAT_TOOL_2026-06.md) — 自研工具 → `cat_files` 遷移腳本、dry-run／`--apply`、衝突規則與 2026-06-11 報告摘要
