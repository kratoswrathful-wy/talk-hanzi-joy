...
- [`docs/bug-report_mqxliff-bpt-inner-markup-tm-mismatch_2026-06.md`](docs/bug-report_mqxliff-bpt-inner-markup-tm-mismatch_2026-06.md) — mqxliff **bpt/ept 內層** TM `<pt>` vs 原文 `<g>`：F8 無法改正、匯出錯 tag（**已修** `reconcileTargetTagsMarkupFromSource`）；Companion `trans-unit id="41"` 範例
