...
| **Bug #9 bpt/ept 內 mq:rxt href 匯出編碼** | **已修**（待 memoQ 匯入複驗） | `prepareRestoredFragmentForXmlParse` 全域 `collapseAmpEntitiesRepeated` 破壞 `&amp;lt;`／`&amp;quot;` → memoQ「Inline tag could not be parsed」。`shouldSkipAmpCollapseForMemoqInline`、`tagXmlNeedsReconcileFromSource` 編碼深度偵測；Consumer Insights 第 505／577 行 | [`xliff-tag-pipeline.js`](../cat-tool/js/xliff-tag-pipeline.js)；[`bug-report_mqxliff-bpt-href-entity-export_2026-06.md`](./bug-report_mqxliff-bpt-href-entity-export_2026-06.md) |
