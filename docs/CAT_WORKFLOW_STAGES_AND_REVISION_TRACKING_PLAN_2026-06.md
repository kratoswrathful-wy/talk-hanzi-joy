...
| **A-3 + A-4** 案件頁「1UP CAT」工具區子區塊 | 第二波 UX + B+D2 + UX 微調 + 加號（`7ae0fc5`～`27d0585`） | **已落地並驗收** | Cursor 大計畫 `1up_ux_與遷移`；摘要 [`CAT_LMS_1UP_UX_AND_MIGRATION_DEVLOG_2026-06.md`](./CAT_LMS_1UP_UX_AND_MIGRATION_DEVLOG_2026-06.md) |
| **A-4b** 自研工具 → `cat_files` 遷移 | 第一批已套用（24+4 案）；**其餘 41 案暫停** | **暫停** | 大計畫 §7；速查 [`CAT_MIGRATE_LEGACY_CAT_TOOL_2026-06.md`](./CAT_MIGRATE_LEGACY_CAT_TOOL_2026-06.md) |
