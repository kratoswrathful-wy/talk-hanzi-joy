...
> **狀態**：**已實作**（待產品端驗收）；**virt 持久化延伸**（Phase 2.3）**已實作，待驗收** — 見 [`CAT_EDITOR_TAG_COLOR_AND_NAV_FIX_2026-06.md`](./CAT_EDITOR_TAG_COLOR_AND_NAV_FIX_2026-06.md) §假游標
...
**驗收**：Riftbound 6333 句 — 編輯句 A → 點 TM → 假游標可見；Ctrl+Alt+↓ 捲回仍有效。
