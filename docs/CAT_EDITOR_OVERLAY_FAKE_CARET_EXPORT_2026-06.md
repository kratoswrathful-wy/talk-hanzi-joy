...
> **狀態**：**已實作**（待產品端驗收）；**virt 持久化** Phase 2.3 **`0670242`** + **2.3b** `694fa81` + **2.3c** `0a073ea` + **2.3d 捲動 preserve**（待驗收）— 見 [`CAT_EDITOR_TAG_COLOR_AND_NAV_FIX_2026-06.md`](./CAT_EDITOR_TAG_COLOR_AND_NAV_FIX_2026-06.md) §2.2／§2.2b／§2.6／§2.7
