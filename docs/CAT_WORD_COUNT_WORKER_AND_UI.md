...
| 2026-05-05 | 補登與本文件同批次驗收相關之 **TM 確認寫入離線效能**（`ActiveTmCache`／`_activeTmCacheReadyIds`、Dexie `tmSegments` v21）；見 [`CODEMAP.md`](CODEMAP.md)、[`HANDOFF.md`](HANDOFF.md)（不擴充本文件 §，以免與字數 Modal 主題混淆）。 |
