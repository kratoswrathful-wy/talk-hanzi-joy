...
| 虛擬捲動 | Phase 2.1 部分有效（`c56cadc`）；**Phase 2.1b** 修正視窗不推進／跳行空白；見 [`CAT_EDITOR_LARGE_FILE_PERF_2026-06.md`](./CAT_EDITOR_LARGE_FILE_PERF_2026-06.md) |
...
4. 大檔虛擬捲動（**Phase 2.1 部分有效**；Phase 2.1b 視窗推進）；同上文件。
