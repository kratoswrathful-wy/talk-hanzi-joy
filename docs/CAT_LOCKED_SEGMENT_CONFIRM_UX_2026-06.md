...
| 虛擬捲動 | Phase 2.1b 部分有效（`ffc74ed`）；**Phase 2.1c** 修正快速捲動飄回頂部；見 [`CAT_EDITOR_LARGE_FILE_PERF_2026-06.md`](./CAT_EDITOR_LARGE_FILE_PERF_2026-06.md) |
...
4. 大檔虛擬捲動（**Phase 2.1b 部分有效**；Phase 2.1c 捲動穩定）；同上文件。
