...
| **Phase B-6 檔案準備閘門**（`prep` 步驟、PM 標記準備完成、派出前 RPC、準備中唯讀鎖） | **已落地** `fd67332`：[`cat-tool/app.js`](../cat-tool/app.js) `computeSegmentEditForbidden`、`_markFilePrepReady`；[`src/lib/cat-prep-dispatch-gate.ts`](../src/lib/cat-prep-dispatch-gate.ts)、[`src/pages/CaseDetailPage.tsx`](../src/pages/CaseDetailPage.tsx)；migration `20260616120000`；規格 [CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md](./CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md) §4 |
