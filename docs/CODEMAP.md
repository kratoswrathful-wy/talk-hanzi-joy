...
| **Phase B-6 檔案準備**（`prep` 步驟、PM 標記準備完成、準備中唯讀鎖） | **已落地** `fd67332`：[`cat-tool/app.js`](../cat-tool/app.js) `computeSegmentEditForbidden`、`_markFilePrepReady`；[`src/pages/CaseDetailPage.tsx`](../src/pages/CaseDetailPage.tsx) 派出後非阻擋 prep 警示（2026-06 解耦見 [CAT_WORKFLOW_PREP_DISPATCH_DECOUPLE_2026-06.md](./CAT_WORKFLOW_PREP_DISPATCH_DECOUPLE_2026-06.md)）；migration `20260616120000`；規格 [CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md](./CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md) §4 |
