...
| **Phase B-7 統一顯示狀態 + 清單／儀表板** | **B-7a 已實作**（`b577c08`）：`cat-tool/js/wf-display-status.js`、`first_edited_at`、清單 grid；**B-7b～d 待實作**（文案、PM 六階、儀表板、指派鎖定）；規格 [CAT_WORKFLOW_B7_UNIFIED_STATUS_AND_LIST_UX_2026-06.md](./CAT_WORKFLOW_B7_UNIFIED_STATUS_AND_LIST_UX_2026-06.md) §11；誤鎖 [bug-report_workflow-whole-file-assign-edit-lock_2026-06.md](./bug-report_workflow-whole-file-assign-edit-lock_2026-06.md) |
