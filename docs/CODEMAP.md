...
| **BCD 波次（2026-07，已驗收）**：**BCD-B** 加權字數 UI 停用；**BCD-C** 小檔清除篩選後假游標置中；**BCD-D** 譯者 noop `Ctrl+Enter` 仍跳下一句。`sync:cat` @ `0312648c`；Playwright PR #23／#25；Cursor smoke + Claude browser acceptance 3/3 pass。細節 [`CAT_BCD_WAVE_PLAYWRIGHT_ACCEPTANCE_2026-07.md`](./CAT_BCD_WAVE_PLAYWRIGHT_ACCEPTANCE_2026-07.md) §0 | [`cat-tool/app.js`](../cat-tool/app.js)、[`tests/cat-bcd-wave-acceptance.spec.ts`](../tests/cat-bcd-wave-acceptance.spec.ts) |
| 字數分析 Modal（`runWordCountAnalysis`、`openWordCountModalWithSelection`、`openWordCountModalFromEditor`、`applyWordCountModalUiMode`；`#wordCountModal`、`#btnEditorWordCount`、`#wordCountEditorScopeWrap`；樣式 `.btn-editor-word-count`）— **BCD-B 後 UI 入口已隱藏** | [`cat-tool/app.js`](../cat-tool/app.js)、[`cat-tool/index.html`](../cat-tool/index.html)、[`cat-tool/style.css`](../cat-tool/style.css) |
...
| **譯文換行編輯補修**（tag 旁刪字、¶ 可刪換行；Wave 1–2：2026-05-27 驗收；**P3 tag 前／tag 間刪字幽靈 br — Wave 3 `bedb855`，2026-06-26 驗收通過**） | [`cat-tool/app.js`](../cat-tool/app.js)：`isGhostBr`／`isGhostBrAfterRtTag`、`tryDeleteSemanticNewlineAtCaret`（W1）；`applyNonPrintMarkers`、`canonicalizeTargetEditorFromExtractPlain`、`isGhostOnlyDiv`（W2）；**W3**：`isGhostBrBeforeRtTag`、tag 間 br（Fix 4A／4B）；基礎見 [`bug-report_contenteditable-newline-artifacts.md`](./bug-report_contenteditable-newline-artifacts.md) `c4f865d`；歷程 [`CAT_TARGET_NEWLINE_EDIT_NP_PLAN.md`](./CAT_TARGET_NEWLINE_EDIT_NP_PLAN.md) **§階段四** |
...
| **批次匯入作業檔精靈**（多選、mqxliff 角色、Excel 全域／逐檔欄位、`runBatchImport`；**團隊版匯入末尾選填連結 LMS 案件** `showCasePickerForImport`／`caseInfo`；匯入後語言對不符 **`#batchImportLangMismatchDialog`**／`openBatchImportLangMismatchDialog`／`_collectXliffLangMismatchIfAny`） | [`cat-tool/app.js`](../cat-tool/app.js)：`showWizardStep`、`showBatchMqRoleModal`、`showBatchExcelConfigModal`、`_refreshBatchExcelStep`、`onBatchExcelSameCfgToggle`、`runBatchImport`、`xliffImportCtx`；[`cat-tool/js/xliff-import.js`](../cat-tool/js/xliff-import.js)、[`cat-tool/js/po-import.js`](../cat-tool/js/po-import.js)（`ctx.caseInfo` → `relatedLmsCaseId`）；[`cat-tool/index.html`](../cat-tool/index.html)：`wizardStepBatchMq`、`wizardStepBatchExcel`、`wizardStepBatchProgress`、多選 `input`；完整構想與驗收見 [CAT_BATCH_IMPORT_WIZARD_SESSION.md](./CAT_BATCH_IMPORT_WIZARD_SESSION.md)；匯入連結案件見 [CAT_IMPORT_CASE_LINK_2026-06.md](./CAT_IMPORT_CASE_LINK_2026-06.md)（`49db7c2`） |
| **CAT 工作階段／追蹤修訂／TMS 整合大計畫**（workflow 步驟、階段指派、追蹤修訂、LMS 案件頁 CAT 區塊；**Phase A／Phase B 已落地**；**B-6 已實作**；**B-7a／b／c 已實作**；B-7d～e 待實作／待排程；Phase C 規劃中） | [CAT_WORKFLOW_STAGES_AND_REVISION_TRACKING_PLAN_2026-06.md](./CAT_WORKFLOW_STAGES_AND_REVISION_TRACKING_PLAN_2026-06.md)；Phase B 規格 [CAT_WORKFLOW_PHASE_B_SPEC_2026-06.md](./CAT_WORKFLOW_PHASE_B_SPEC_2026-06.md)（§11.7～§11.9、§12 B-6、§13 B-7）；**B-6** [CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md](./CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md)；**B-7** [CAT_WORKFLOW_B7_UNIFIED_STATUS_AND_LIST_UX_2026-06.md](./CAT_WORKFLOW_B7_UNIFIED_STATUS_AND_LIST_UX_2026-06.md)；**B-0 排序** [CAT_SORT_AND_DISPLAY_ORDER_SPEC_2026-06.md](./CAT_SORT_AND_DISPLAY_ORDER_SPEC_2026-06.md) |
| **Phase B-6 檔案準備**（`prep` 步驟、PM 標記準備完成、準備中唯讀鎖） | **已落地** `fd67332`；**派出與 prep 解耦已驗收** `d247d9a`：[`cat-tool/app.js`](../cat-tool/app.js) `computeSegmentEditForbidden`、`_markFilePrepReady`；[`src/pages/CaseDetailPage.tsx`](../src/pages/CaseDetailPage.tsx) 派出後非阻擋 prep 警示；migration `20260616120000`、`20260623131500`；規格 [CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md](./CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md) §4；解耦紀錄 [CAT_WORKFLOW_PREP_DISPATCH_DECOUPLE_2026-06.md](./CAT_WORKFLOW_PREP_DISPATCH_DECOUPLE_2026-06.md) |
| **Phase B-6 審稿任務完成**（session 分流、PM 審稿完成調整狀態） | **已落地** `fd67332`：[`cat-tool/app.js`](../cat-tool/app.js) `_wfReviewAssignmentsInContext`、`_validateAssignmentForReviewTaskComplete`、`refreshWfTaskCompleteToolbar`、`_pmApplyWholeFileReviewState`；規格 §5 |
| **Phase B-7 統一顯示狀態 + 清單／儀表板** | **B-7a／b／c 已實作**：`wf-display-status.js`、PM 六階、清單 grid、儀表板 `cat_file_user_access`；**B-7d～e 待實作／待排程**；規格 [CAT_WORKFLOW_B7_UNIFIED_STATUS_AND_LIST_UX_2026-06.md](./CAT_WORKFLOW_B7_UNIFIED_STATUS_AND_LIST_UX_2026-06.md)；誤鎖 [bug-report_workflow-whole-file-assign-edit-lock_2026-06.md](./bug-report_workflow-whole-file-assign-edit-lock_2026-06.md)；狀態欄 [bug-report_workflow-import-confirmed-status-column_2026-06.md](./bug-report_workflow-import-confirmed-status-column_2026-06.md)；**stage／assignment 同步防降級（2026-07 已驗收）** [CAT_META_EXTRA_INFO_AND_WF_STATUS_PLAN_2026-07.md](./CAT_META_EXTRA_INFO_AND_WF_STATUS_PLAN_2026-07.md)、[CAT_WF_ASSIGNMENT_BACKFILL_INVENTORY_2026-07-14.md](./CAT_WF_ASSIGNMENT_BACKFILL_INVENTORY_2026-07-14.md)、`wf-assignment-sync-policy.js`；PR `#40` |
| **Phase B Workflow 工具列**（任務完成按下驗證、調整狀態、開檔 session 選步驟） | [`cat-tool/app.js`](../cat-tool/app.js)：`refreshWfTaskCompleteToolbar`、`_validateAssignmentForTaskComplete`、`_onWfTaskCompleteMainClick`、`_completeWfStageAssignmentById`、`_assignmentRangeConfirmAudit`；[`cat-tool/index.html`](../cat-tool/index.html) `#wfTaskCompleteToolbar`；規格 §4.1、§11.4.1、§11.9 |
| **Phase B LMS 雙向同步**（協作列任務完成勾選驗證、CAT→LMS 狀態升級） | [`src/lib/cat-collab-task-complete.ts`](../src/lib/cat-collab-task-complete.ts)、[`CollaborationTable.tsx`](../src/components/CollaborationTable.tsx)、[`src/lib/cat-wf-lms-sync.ts`](../src/lib/cat-wf-lms-sync.ts)；migration `20260615120000_fix_collab_row_id_text.sql` |
| **更新作業檔×句段集確認 Modal**（新句勾選、多人拆段新列範圍） | [`cat-tool/app.js`](../cat-tool/app.js) `showFileUpdateViewsModal`、`_syncViewsAfterFileUpdate`；[`cat-tool/index.html`](../cat-tool/index.html) `#fileUpdateViewsModal`；[`cat-tool/db.js`](../cat-tool/db.js) `upsertTranslateStageAssignment`；規格 [CAT_SORT_AND_DISPLAY_ORDER_SPEC_2026-06.md](./CAT_SORT_AND_DISPLAY_ORDER_SPEC_2026-06.md) §5、§7；Phase B §11.8（`76be7ee`） |
...
| **額外資訊限高＋雙擊複製／展開鈕（2026-07 已驗收）** | 純顯示層（不改 `extraValue`）；[`cat-tool/js/extra-info-display.js`](../cat-tool/js/extra-info-display.js)：三行 clamp、長 token 縮短、右上角三角展開鈕、雙擊複製完整段落；[`cat-tool/app.js`](../cat-tool/app.js)：Key／檔名雙擊複製；PR `#41`／互動改版於 `#42` `7f4c1e13` |
| **meta_items 欄位對應＋chip（2026-07 已驗收）** | 匯入收集 `metaItems`；檔／專案 `meta_display_config`／`meta_display_templates`；未設 config ≡ 舊行為；不改 `xliffTuId`／匯出 XML。[`meta-items-collector.js`](../cat-tool/js/meta-items-collector.js)、[`meta-display-apply.js`](../cat-tool/js/meta-display-apply.js)、[`meta-display-map-ui.js`](../cat-tool/js/meta-display-map-ui.js)；migrations `20260714130000`／`20260714140000`；Dexie／[`cat-cloud-rpc.ts`](../src/lib/cat-cloud-rpc.ts)；計畫 [CAT_META_EXTRA_INFO_AND_WF_STATUS_PLAN_2026-07.md](./CAT_META_EXTRA_INFO_AND_WF_STATUS_PLAN_2026-07.md)；PR `#42` merge `153f15d1` |
...
| 案件詳情「1UP CAT」工具區子區塊（`cat_tool_enabled` + `related_lms_case_id`；完整紀錄見 Cursor 大計畫 `1up_ux_與遷移`） | `CaseCatToolsPanel.tsx`、`CaseDetailPage.tsx`、`case-tool-count.ts`；摘要 [`CAT_LMS_1UP_UX_AND_MIGRATION_DEVLOG_2026-06.md`](./CAT_LMS_1UP_UX_AND_MIGRATION_DEVLOG_2026-06.md) |
...
| **production registry 現況**（2026-07-06，Phase 3B′ 驗收後） | enabled **5**：`gpt-5.5`、`gpt-5.4-mini`、`gpt-4.1`、`gpt-4.1-mini`、`gpt-5.5-pro`；default：**gpt-5.5**；`cat_ai_settings.model`：**gpt-4.1** |
| **CAT AI Model Registry Phase 3B′**（精選模型選單；**已驗收**） | lib `src/lib/cat-ai-model-registry/`；RPC `db.listEnabledCatAiModelOptions`；CAT `cat-tool/js/ai-model-picker.js`、`openAiSettingsView`（`cat-tool/app.js`）；hotfix 測試 `api/lib/cat-ai-settings-direct-route.test.js`；規格 [`docs/CAT_AI_MODEL_REGISTRY_PHASE3B_PRIME_SPEC_2026-07.md`](./CAT_AI_MODEL_REGISTRY_PHASE3B_PRIME_SPEC_2026-07.md)；DEVLOG [`docs/CAT_AI_MODEL_REGISTRY_PHASE3B_DEVLOG_2026-07.md`](./CAT_AI_MODEL_REGISTRY_PHASE3B_DEVLOG_2026-07.md) |
