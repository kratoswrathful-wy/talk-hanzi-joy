...
| **CAT 工作階段／追蹤修訂／TMS 整合大計畫**（workflow 步驟、階段指派、追蹤修訂、LMS 案件頁 CAT 區塊；**Phase A／Phase B 已落地**；**B-6 規劃中**；Phase C 規劃中） | [CAT_WORKFLOW_STAGES_AND_REVISION_TRACKING_PLAN_2026-06.md](./CAT_WORKFLOW_STAGES_AND_REVISION_TRACKING_PLAN_2026-06.md)；Phase B 規格 [CAT_WORKFLOW_PHASE_B_SPEC_2026-06.md](./CAT_WORKFLOW_PHASE_B_SPEC_2026-06.md)（§11.7～§11.9、§12 B-6 摘要）；**B-6** [CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md](./CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md)；**B-0 排序** [CAT_SORT_AND_DISPLAY_ORDER_SPEC_2026-06.md](./CAT_SORT_AND_DISPLAY_ORDER_SPEC_2026-06.md) |
| **Phase B-6 檔案準備閘門**（`prep` 步驟、PM 標記準備完成、派出前 RPC、準備中唯讀鎖） | 規劃中：[`cat-tool/app.js`](../cat-tool/app.js) `computeSegmentEditForbidden`、檔案清單；[`src/pages/CaseDetailPage.tsx`](../src/pages/CaseDetailPage.tsx) 派出閘門；migration `cat_case_all_linked_files_prep_ready`；規格 [CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md](./CAT_WORKFLOW_PREP_AND_REVIEW_B6_SPEC_2026-06.md) §4 |
| **Phase B-6 審稿任務完成**（session 分流、PM 審稿完成調整狀態） | 規劃中：[`cat-tool/app.js`](../cat-tool/app.js) `_wfReviewAssignmentsInContext`、`_validateAssignmentForReviewTaskComplete`、`refreshWfTaskCompleteToolbar`、`_pmApplyWholeFileReviewState`；規格 §5 |
