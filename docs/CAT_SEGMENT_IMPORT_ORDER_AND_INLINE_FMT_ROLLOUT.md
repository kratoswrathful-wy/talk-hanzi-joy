...
**與左欄顯示序**：`globalId`＝**母檔匯入序**（檔內排序鍵、更新作業檔對帳）；編輯器左欄 **1、2、3…** 為**全清單顯示列序**，句段集亦同 — 見 [`CAT_SORT_AND_DISPLAY_ORDER_SPEC_2026-06.md`](./CAT_SORT_AND_DISPLAY_ORDER_SPEC_2026-06.md)。
